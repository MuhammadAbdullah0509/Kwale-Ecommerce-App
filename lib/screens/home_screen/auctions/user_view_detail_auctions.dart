...
class UserViewAuctionDetail extends StatefulWidget {
  String? productId;
  UserViewAuctionDetail({super.key, this.productId});

  @override
  State<UserViewAuctionDetail> createState() => _UserViewAuctionDetailState();
}

class _UserViewAuctionDetailState extends State<UserViewAuctionDetail> {
